...
QT_MOC_LITERAL(1, 12, 13), // "signal_RGBBuf"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 14), // "unsigned char*"
QT_MOC_LITERAL(4, 42, 6) // "rgbBuf"

    },
    "VideoThread\0signal_RGBBuf\0\0unsigned char*\0"
    "rgbBuf"
};
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_RGBBuf((*reinterpret_cast< unsigned char*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VideoThread::*)(unsigned char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoThread::signal_RGBBuf)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoThread::signal_RGBBuf(unsigned char * _t1)
{
