...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataReceived_GD((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SerialManager::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::dataReceived_GD)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SerialManager::dataReceived_GD(const QByteArray & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
