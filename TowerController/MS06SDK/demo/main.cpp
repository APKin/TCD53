...
int main(int argc, char* argv[])
{
	...
	if (argc >= 3)
	{
		...
		else
		{
			...
			if (mGatewayIP != "") m_GetLidarData->setGatewayIP(mGatewayIP, InfoString);
			if (mSubnetMaskIP != "") m_GetLidarData->setSubnetMaskIP(mSubnetMaskIP, InfoString);
		}
...
#pragma region //Read back the Lidar parameters
	...
	//	std::cout.width(20); std::cout << "FirmwareVersionFPGA	=	" << mLidarStateParam.FirmwareVersionFPGA << std::endl;
	//	std::cout.width(20); std::cout << "FirmwareVersionFPGA_Board2	=	" << mLidarStateParam.FirmwareVersionFPGA_Board2 << std::endl;
	//	std::cout.width(20); std::cout << "FirmwareVersionFPGA_Board3	=	" << mLidarStateParam.FirmwareVersionFPGA_Board3 << std::endl;
	//	std::cout.width(20); std::cout << "PrincipalNumber	=	" << mLidarStateParam.PrincipalNumber << std::endl;
	// 
	...
	//	std::cout.width(20); std::cout << "OuterCoverDirtinessInformation	=	" << mLidarStateParam.OuterCoverDirtinessInformation << std::endl;
