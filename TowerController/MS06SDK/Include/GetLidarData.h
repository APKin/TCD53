...
* Modify Record :	1：Added new LiDAR type MS01
					...
					3: Increased vertical Angle output for hybrid solid-state Lidar（CH）
* Description :		
...
* * Version           : v2.1.9
* Date				: 2025 / 03
* Modify Record :	1: Added LiDAR firmware version information and principal number
					2: Added new LiDAR type LSS4
* Description :		
...
* * Version           : v2.1.10
* Date				: 2025 / 05
* Modify Record :	1: Added fault code output for CH and Cx series Lidar
* Description :		
...
typedef struct _LidarStateParam
{
	...
	std::string FirmwareVersionFPGA = "-1";			//Firmware version information 
	std::string FirmwareVersionFPGA_Board2 = "-1";	//Firmware version information of board 2
	std::string FirmwareVersionFPGA_Board3 = "-1";	//Firmware version information of board 3
	std::string PrincipalNumber = "-1";				//Principal number

	int DataPort = -1;								//Lidar data pakcet port
	int DevPort = -1;								//Lidar device pakcet port

	int OuterCoverDirtinessInformation = -1;		//Outer Cover Dirtiness Information  0 Clean;  1:Slightly Dirty;  2: Moderately Dirty  3:Heavily Dirty
...
public:
	...
	int mModeratelyDirtyThreshold = 20;									// Moderately Dirty Threshold
	int mHeavilyDirtyThreshold = 40;									// Heavily Dirty Threshold
