...
#define GetLidarData_MS06_MACRO											// predefined, fill in the lidar model that is to be used
...
#include "DataDispose_C_v4_0_C1S.cpp"
...
#include "GetLidarData_LS.cpp"
 ...
 // create class of  LSS4
#ifdef GetLidarData_LSS4_MACRO
#include "GetLidarData_LSS4.h"
#include "GetLidarData_LSS4.cpp"
			 GetLidarData* m_GetLidarData = new GetLidarData_LSS4;				// create class of  LS
#endif
